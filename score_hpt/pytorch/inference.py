...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        help="Strategy when converting velocity rolls to per-note values. onset_only is the default for HPT / score-HPT; max_frame remains available for FiLM-UNet-style baselines.",
    )
    parser.add_argument(
        "--midi-format",
        default="maestro",
