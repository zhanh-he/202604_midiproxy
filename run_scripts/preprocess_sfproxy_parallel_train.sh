...
launch_export() {
  local preset="$1"
  local out_dir="${DATA_DIR}/${INSTRUMENT_NAME}/${preset}_${tag}_${BOUNDARY_MODE}/train"
...
for preset in boundary_v2 coverage_v2 realism_v2 stress_v2; do
  log_path="${LOG_DIR}/${INSTRUMENT_NAME}_${preset}_${tag}_${BOUNDARY_MODE}_train_${RUN_STAMP}.log"
  echo "launch ${preset} train -> ${log_path}"
...
out_dir="${DATA_DIR}/${INSTRUMENT_NAME}/mixed_v2_${tag}_${BOUNDARY_MODE}/train"
rm -rf "${out_dir}"
compose_log="${LOG_DIR}/${INSTRUMENT_NAME}_mixed_v2_${tag}_${BOUNDARY_MODE}_train_${RUN_STAMP}.log"

python "${ROOT_DIR}/synth-proxy/src/tools/compose_exported_dataset.py" \
  --input-dirs \
    "${DATA_DIR}/${INSTRUMENT_NAME}/boundary_v2_${tag}_${BOUNDARY_MODE}/train" \
    "${DATA_DIR}/${INSTRUMENT_NAME}/coverage_v2_${tag}_${BOUNDARY_MODE}/train" \
    "${DATA_DIR}/${INSTRUMENT_NAME}/realism_v2_${tag}_${BOUNDARY_MODE}/train" \
    "${DATA_DIR}/${INSTRUMENT_NAME}/stress_v2_${tag}_${BOUNDARY_MODE}/train" \
