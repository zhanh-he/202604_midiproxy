...
from train_defaults import build_synthesis_config, apply_synthesis_overrides, parse_synthesis_args
...
if __name__ == "__main__":
    cli_args = parse_synthesis_args()
    wandb_config = apply_synthesis_overrides(build_synthesis_config(), cli_args)
    wandb_config = {
        **wandb_config,
    ...
    model = SynthesisBase(wandb.config.as_dict())
