...
####### General Audio #######
# Repo default contract for new DDSP-Guitar-Synth runs.
# Note: the hop length must be an integer. With 22050 Hz and target 100 fps,
# the closest integer hop is 221 samples, which gives an effective frame rate
# of 22050 / 221 = 99.7738 fps.
SR = 22050
FRAME_RATE_TARGET = 100.0
HOP_LENGTH = _round_half_up(SR / FRAME_RATE_TARGET)
FRAME_RATE = SR / HOP_LENGTH
N_FFT = 2048
ITEM_DUR = 10.0  # training item duration in seconds
...
PER_STRING_INHARM_BETA_INIT = [
    ...
    5.11e-5,
    2.09e-5,
    # These values are the measured beta values (post sigmoid!).
    # From: https://publicwebuploads.uwec.edu/documents/Musical-string-inharmonicity-Chris-Murray.pdf
]
...
# Repo default loss FFT sizes are now [128, 256, 512, 1024, 2048].
NUM_SPECTRAL_LOSSES = 5
MIN_SPECTRAL_LOSS_FFT_SIZE = 128
