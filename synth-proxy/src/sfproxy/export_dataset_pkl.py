...
Run example:
  python src/sfproxy/export_dataset_pkl.py --config-name data_piano dataset_size=20000
...
# Allow running this file directly with `python src/sfproxy/export_dataset_pkl.py`
...
@hydra.main(version_base=None, config_path="../../configs/sfproxy", config_name="data")
